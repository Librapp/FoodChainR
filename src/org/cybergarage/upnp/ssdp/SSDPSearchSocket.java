...
public class SSDPSearchSocket extends HTTPMUSocket implements Runnable {
	 ...
	 * 
	 * @param bindAddr
	 *            the binding address for sending multicast packet
	 * @since 1.8
	 */
	 ...
	 * 
	 * @param bindAddr
	 *            the host name of the interface to use for sending multicast
	 *            packet
	...
	public void performSearchListener(SSDPPacket ssdpPacket) {
		...
		for (int n = 0; n < listenerSize; n++) {
			SearchListener listener = (SearchListener) deviceSearchListenerList
					.get(n);
